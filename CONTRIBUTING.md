# Contributing to bookmarks-chat
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/bookmarks-chat.git
   cd bookmarks-chat
   ```
...
- Open a [Discussion](https://github.com/YOUR_ORG/bookmarks-chat/discussions)
- Review existing [Issues](https://github.com/YOUR_ORG/bookmarks-chat/issues)
